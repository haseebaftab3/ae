<header id="page-topbar" class="darkmode--ignored">
    <div class="navbar-header p-b">
        <!-- LOGO -->
        <div class="navbar-brand-box d-flex align-items-left col-3 ">
            <a href="../index.php" class="logo">
                <img src="assets/images/logo/logo.png" alt="" class="img-thumbnail darkmode-ignore" style="height:50px;">
            </a>
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown d-inline-block ml-2">
                <button type="button" class="btn header-item waves-effect waves-light" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="assets/images/icons/user.png" alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item d-flex align-items-center justify-content-between" href="lock-screen.php">
