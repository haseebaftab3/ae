    ...
    if (mysqli_num_rows($check) > 0) {
        while ($row = mysqli_fetch_array($check)) {
            ...
            if ($row['Img'] == "") {
                ...
                $html .= '<td class="p-0 d-flex justify-content-center"><img style="height:68px" class="img-thumbnail rounded" src="uploads/Manufacturer/' . $row['Img'] . '"></td>';
            }

            $html .= '<td>
        <div class="d-flex justify-content-end">
        <a href="#" data-toggle="modal" class="CommentIcon" data-target="#EditManufactureModal" 
        data-id="' . $row[0] . '" >
        ...
        <a href="#" data-toggle="modal"  class="CommentIcon" data-target="#DeleteManufactureRecord" 
        data-id="' . $row[0] . '">
