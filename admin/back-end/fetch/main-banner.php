...
$html = "";
$i = 1;
$sql = "SELECT * FROM `main_page_banner`";
    ...
    if (mysqli_num_rows($check) > 0) {
        while ($row = mysqli_fetch_array($check)) {
            ...
            if ($row['Image'] == "") {
                ...
                $html .= '<td class="p-0 d-flex justify-content-center"><img style="height:68px" class="img-thumbnail rounded" src="uploads/banner/' . $row['Image'] . '"></td>';
            }
            //Alt
          
            $html .= '<td>
        <div class="d-flex justify-content-end">
        <a href="#" data-toggle="modal" class="CommentIcon" data-target="#EditBannerRecord" 
        data-id="' . $row[0] . '" >
        ...
        <a href="#" data-toggle="modal"  class="CommentIcon" data-target="#DeleteBannerRecord" 
        data-id="' . $row[0] . '">
