...
if (!empty($Image)) {
        ...
        if ($_FILES["image"]["size"] > 1000000) {
            ...
            if (
                ...
                if ($uploadOk == 0) {
                    ...
                    if (file_exists("../../uploads/Offer/" . $OldImg)) {
                        unlink("../../uploads/Offer/" . $OldImg);
                    }
                    ...
                    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
                        //query
                        $query = "UPDATE `ads` SET `Name`='$Title',`Image`='$Image',`Link`='$Link' WHERE ID=$ID";
                        //query checker
    ...
    $query = "UPDATE `ads` SET `Name`='$Title',`Link`='$Link' WHERE ID=$ID";
