...
$('[data-toggle="daterangepicker"]').each(function (a, e) {
  var t = $.extend({}, defaultOptions, $(e).data());
  $(e).daterangepicker(t);
});
...
$('[data-toggle="date-picker-range"]').each(function (a, e) {
  var t = $.extend({}, defaultRangeOptions, $(e).data()),
    n = t.targetDisplay;
  $(e).daterangepicker(t, function (a, e) {
    n && $(n).html(a.format("MMMM D, YYYY") + " - " + e.format("MMMM D, YYYY"));
  });
});
