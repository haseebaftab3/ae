...
!(function (e) {
  ...
  e(function () {
    if (e("#pieChart").length) {
      var r = e("#pieChart").get(0).getContext("2d");
      new Chart(r, {
        type: "pie",
        data: {
          datasets: [
            {
              data: [21, 16, 48, 31],
              backgroundColor: ["#2e7ce4", "#f5c842", "#38b3d6", "#df3554"],
              borderColor: ["#2e7ce4", "#f5c842", "#38b3d6", "#df3554"],
            },
          ],
          labels: ["Samsung", "Apple", "Vivo", "Motorola"],
        },
        options: {
          responsive: !0,
    ...
    if (e("#lineChart").length) {
      var a = e("#lineChart").get(0).getContext("2d");
      new Chart(a, {
        type: "line",
        data: {
          labels: [
        ...
        options: {
          scales: {
            yAxes: [
              {
                gridLines: { drawBorder: !1, borderDash: [3, 3] },
                ticks: { min: 0 },
              },
            ],
            xAxes: [
